              ...
              <div class="row justify-between" style="max-width: 768px">
                <div class="infoBox">
                  <div class="infoBoxContent">
                    <div class="text">
                      <span>{{ $t("strings.sispopBalance") }}</span>
                    </div>
                    <div class="value">
                      <span><FormatSispop :amount="address.balance"/></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="infoBox">
                  <div class="infoBoxContent">
                    <div class="text">
                      <span>{{ $t("strings.sispopUnlockedBalance") }}</span>
                    </div>
                    <div class="value">
                      <span
                        ><FormatSispop :amount="address.unlocked_balance"
                      /></span>
                    </div>
                  </div>
                </div>
