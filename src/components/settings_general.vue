  ...
  <div class="settings-general">
    ...
    <template v-if="config_daemon.type != 'local'">
      <div class="row q-mt-md pl-sm">
        <SispopField class="col-8" :label="$t('fieldLabels.remoteNodeHost')">
          <q-input
        ...
        <SispopField class="col-4" :label="$t('fieldLabels.remoteNodePort')">
          <q-input
    ...
    <div class="col q-mt-md pt-sm">
      <SispopField :label="$t('fieldLabels.dataStoragePath')" disable-hover>
        <q-input
      ...
      <SispopField :label="$t('fieldLabels.walletStoragePath')" disable-hover>
        <q-input
    ...
    >
      <div class="row pl-sm q-mt-sm">
        ...
        <SispopField class="col-6" :label="$t('fieldLabels.walletLogLevel')">
          <q-input
      ...
      <div class="row pl-sm q-mt-md">
        ...
        <SispopField class="col-3" :label="$t('fieldLabels.internalWalletPort')">
          <q-input
