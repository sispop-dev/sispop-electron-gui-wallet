export default {
  ...
  menuItems: {
    ...
    exit: "Cerrar la interfaz del monedero Sispop",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "sispopd no encontrado, utilizando nodo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    sispopBalance: "Saldo",
    sispopUnlockedBalance: "Saldo libre",
    sispopUnlockedShort: "Libre",
    ...
    serviceNodeRegistrationDescription:
      'Introduzca la orden {registerCommand} generada por el servicio (sispopd) que se está intentado registrar como Nodo de Servicio usando la instrucción "{prepareCommand}"',
    spendKey: "Clave de gasto",
