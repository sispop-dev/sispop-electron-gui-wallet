...
Some common URLs:
    https://download.sispop.site/sispop.site/sispop-core/sispop-stable-linux-LATEST.tar.xz
    https://download.sispop.site/sispop.site/sispop-core/sispop-stable-win-LATEST.zip
    https://download.sispop.site/sispop.site/sispop-core/sispop-stable-macos-LATEST.tar.xz
    https://download.sispop.site/sispop.site/sispop-core/sispop-dev-linux-LATEST.tar.xz
    https://download.sispop.site/sispop.site/sispop-core/sispop-dev-win-LATEST.zip
    https://download.sispop.site/sispop.site/sispop-core/sispop-dev-macos-LATEST.tar.xz
EOF
    exit 1
fi
